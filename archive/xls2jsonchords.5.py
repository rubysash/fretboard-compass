...
# for stupid webbrwoser + chrome / bug
#from os import path # fixme:  required full module anyway
...
def dump_scales(scales):
                ...
                for i in range(len(fixedlist)):
                    ...
                    for y in fret_pos:
                        ...
                        if y > 100:
                            ...
                            make_dots(xx,yy,8,'black')           # this is the finger position, the actual dot
                        else:
    ...
    d_sorted = collections.OrderedDict(sorted(s_data.items(), key=lambda t:t[1]["name"]))
...
def dump_chords(chords):
    ...
    # requires "collections" module, sorts our dicitonary
    d_sorted = collections.OrderedDict(sorted(c_data.items(), key=lambda t:t[1]["name"]))
